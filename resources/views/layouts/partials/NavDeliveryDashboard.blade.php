...
<style>
  ...
  .menu-link.active {
    ...
    font-weight: bold;
								...
								<div class="menu-item">
									<a class="menu-link   {{ request()->routeIs('delivery') ? 'active' : '' }}" href= "{{ route('delivery') }}">
								...
								<div class="menu-item">
									 ...
									 <span class="menu-icon">
										...
										<span class="menu-title">Delivery Men</span>
									</a>
								</div>
								<div class="menu-item">
								<a class="menu-link {{ request()->routeIs('deliveriesArea.*') ? 'active' : '' }}" href="{{ route('deliveriesArea.index') }}">
										<span class="menu-icon">
										...
										<span class="menu-title">Delivery areas</span>
									</a>
								</div>
								<div class="menu-item">
									<a class="menu-link">
