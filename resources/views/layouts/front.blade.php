            ...
            <div class="col-lg-5 col-md-4 col-12">
                <div class="top-end">
                    ...
                    <ul class="user-login">
                        ...
                        <li>
                            <a href="{{route('addStore')}}" target="_blank">
                        ...
                        <li class="select-position">
                            <select class="select5" id="select-redirect" style="background-color: #000; color: #fff">
                                <option>Select Login</option>
                                <option value="{{route('vendor')}}" data-target="_blank">
                                    {{Lang::get('login Vendor')}}
                                </option>
                                <option value="{{route('delivery')}}" data-target="_blank">
                                    {{Lang::get('login Delivery')}}
                                </option>
                                <option value="{{route('admin/dashboard')}}" data-target="_blank">
                                    {{Lang::get('login Admin')}}
                                </option>
                            </select>
                        </li>
                        <script>
                            const selectRedirect = document.getElementById('select-redirect');
                            selectRedirect.addEventListener('change', function () {
                                const selectedOption = selectRedirect.options[selectRedirect.selectedIndex];
