            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted"><a
                            class="text-muted text-hover-primary">Store</a></li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <li class="breadcrumb-item text-dark"><a
                            class="text-muted text-hover-primary">My Store</a></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div style="overflow-x: auto;">
                        <table
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <!--end::Checkbox-->
                                    <td><a class="text-gray-800 text-hover-primary mb-1">{{$store->id}}</a></td>
                                    <td><a class="text-gray-600 text-hover-primary mb-1">{{$store->name}}</a></td>
                                    <td>{{$store->slug}}</td>
                                    <td><img width="80" src="{{asset('storage/'.$store->image)}}" alt="No Image"></a></td>
                        ...
                        {{-- {{ $store->withQueryString()->appends(['search' => 1])->links() }} --}}
                    </div>
                    <!--end::Table-->
                </div>
                <!--end::Card body-->
