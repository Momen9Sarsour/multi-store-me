...
@section('dashboard')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="card-header d-flex mt-4">
            <div class="col-md-9">
                <h4 class="card-title"> Employee Vendor - Product - Edit Product </h4>
            </div>
        </div>
        <!--end::Toolbar-->
        <!--begin::Post-->
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                @endif
                <form  action="{{ route('employeeVendor/product/update',$product->id) }}" method="POST"  enctype="multipart/form-data">
              @csrf
              @method('put')
             ...
             <div class="form-group py-4">
                ...
                <input type="number" name="storgeQuantity" class="form-control" value="{{ $product->storgeQuantity }}">
            </div>
                <div class="form-group py-4">
