                        ...
                        <div class="product-grids-head">
                            <div class="product-grid-topbar">
                                <div class="row align-items-center">
                                    ...
                                    <p class="fs-6">
                                        The Category is &nbsp; &nbsp;
                                        <span class="fs-4" style="color: blue"><b>{{ $product[0]->category ? $product[0]->category->name : 'Not Found' }}</b></span>
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane fade show active" id="nav-grid" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="single-product" style="height: 380px">
                                                <div class="product-image">
                                                    <img src="{{asset('storage/'.$product->image)}}" width="120" height="200" alt="No Image Product">
                                                    <div class="button">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="price">
                                                        ...
                                                        &nbsp;&nbsp;
                                                        <span class="discount-price" style="color: red">{{ $product->compare_price ? Currency::format($product->compare_price) : '' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- End Single Product -->
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="pagination left">
                                                <ul class="pagination-list">
                                                    {{$product->paginate(9)->appends(['search' => $search ])->links()}}
                                                </ul>
                                            </div>
                                            <!--/ End Pagination -->
                                        </div>
