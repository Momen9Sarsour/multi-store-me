                                        ...
                                        <div class="row">
                                            ...
                                            {{-- <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>City</label>
                                                    <div class="form-input form">
                                                        <select name="addr[billing][city]" class="form-control form-select" >
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>City</label>
                                                    <div class="form-input form">
                                                        <select name="addr[billing][city]" class="form-control form-select" id="city-select">
                                                            <option>Select City</option>
                                                            @foreach($city as $key => $value)
                                                                <option value="{{ $value->city }}" data-price="{{ $value->DeliverPrice }}">{{ $value->city }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                    ...
                    <div class="checkout-sidebar">
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price" id="subtotal-price">{{ Currency::format($cart->total()) }}</p>
                                </div>
                                <div class="total-price shipping">
                                    <p class="value">Delivery Price:</p>
                                    <p class="price" id="delivery-price">$0.00</p>
                                </div>
                            </div>
                            ...
                            <div class="total-payable">
                                <div class="payable-price">
                                    ...
                                    <p class="price" id="total-price">{{ Currency::format($cart->total()) }}</p>
                                </div>
                            </div>
                        ...
                        <script>
                            ...
                            citySelect.addEventListener('change', function () {
                                ...
                                const subtotal = parseFloat(subtotalPrice.textContent.replace('$', '').replace(',', ''));
                                const total = subtotal + price;

                                deliveryPrice.textContent = `$${price.toFixed(2)}`;
