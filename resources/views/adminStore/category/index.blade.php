    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted"><a href="{{ route('adminCategory.index') }}"
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark"><a href="{{ route('adminCategory.index') }}"
                        class="text-muted text-hover-primary">Categories Listing</a></li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            <!--begin::Button-->
            {{-- <a href="{{ route('adminCategory.create') }}" class="btn btn-md btn-primary"
                id="kt_toolbar_primary_button">Add New Category</a> --}}
            <!--end::Button-->
        </div>
        <!--end::Actions-->
    </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--end::Checkbox-->
                                <td><a href="{{ route('adminCategory.show', $category->id) }}"
                                        class="text-gray-800 text-hover-primary mb-1">{{ $category->id }}</a></td>
                                <td><a href="{{ route('adminCategory.show', $category->id) }}"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $category->name }}</a></td>
                                <td>{{ $category->slug }}</td>
                                <td><img width="80" src="{{ asset('storage/' . $category->image) }}"
                                        alt="No image category" /></a></td>
