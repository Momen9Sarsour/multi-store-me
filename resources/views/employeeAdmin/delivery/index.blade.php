        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted"><a href="" class="text-muted text-hover-primary">Deliveries</a></li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item"><span class="bullet bg-gray-200 w-5px h-2px"></span>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark"><a href="" class="text-muted text-hover-primary">Deliveries Listing</a></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    <!--begin::Card title-->
                    <form action="{{ url('/employeeAdmin/delivery') }}" method="get">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <!--begin::Add customer-->
                            <a href="{{ url('/employeeAdmin/delivery/create') }}" class="btn btn-primary">Add Delivery</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                    </div>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @forelse($deliveries as $delivery)
                                <tr>
                                    ...
                                    <!--end::Checkbox-->
                                    <td><a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $delivery->id }}</a></td>
                                    <td><a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $delivery->name }}</a></td>
                                    <td><img width="80" src="{{ asset('storage/' . $delivery->image) }}" alt="No image delivery"></a></td>
                                    ...
                                    <td class="">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ url('/employeeAdmin/delivery/edit', $delivery->id) }}"
                                                    class="btn btn-sm btn-outline-success ">Edit</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <form action="{{ url('/employeeAdmin/delivery/delete', $delivery->id) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Export Delivery</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
