...
<!--begin::Content-->
    <!--<div class="content d-flex flex-column flex-column-fluid" id="kt_content">-->
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted"><a href="" class="text-muted text-hover-primary">Products</a></li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-200 w-5px h-2px"></span>
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark"><a href="" class="text-muted text-hover-primary">Products Listing</a></li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="post d-flex flex-column-fluid mt-5" id="kt_post">
            <!--begin::Container-->
            <div id="kt_content_container mt-5" class="container-xxl">
                <!--begin::Card-->
                <div class="card">
                    <!--begin::Card header-->
                    <div class="card-header border-0 pt-6">
                        <!--begin::Card title-->
                        <form action="{{route('employeeAdmin/product')}}" method="get">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <!--begin::Add customer-->
                                <a href="{{ route('employeeAdmin/product/create') }}" class="btn btn-primary">Add Product</a>
                                <!--end::Add customer-->
                            </div>
                            <!--end::Toolbar-->
                            <!--begin::Group actions-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-75px">Store</th>
                                    <th class="min-w-75px">Category</th>
                                    <th class="min-w-75px">Slug</th>
                                    <th class="min-w-125px">Description</th>
                                    <th class="min-w-75px">Image</th>
                                    <th class="min-w-75px">price</th>
                                    <th class="min-w-75px">Compare Price</th>
                                    <th class="min-w-75px">Storge Quantity</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <!--end::Checkbox-->
                                    <td><a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $product->id }}</a></td>
                                    <td><a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $product->name }}</a></td>
                                    <td>{{ $product->store ? $product->store->name : 'No Store' }}</td>
                                    <td>{{ $product->category->name }}</td>
                                    <td>{{ $product->slug }}</td>
                                    <td>{{ $product->description }}</td>
                                    <td><img width="80" src="{{ asset('storage/' . $product->image) }}" alt="No Image"></td>
                                    <td>{{ $product->price }}</td>
                                    ...
                                    <td class="">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ url('employeeAdmin/product/edit', $product->id) }}" class="btn btn-sm btn-outline-success">Edit</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <form action="{{ url('employeeAdmin/product/delete', $product->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
