...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            @endif
            <form action="{{ url('/employeeAdmin/product/store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group py-4">
                    <label for="">Product Name</label>
                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Enter the product name">
                </div>
                <div class="form-group py-4">
                ...
                <div class="form-group py-4">
                    ...
                    <input type="number" class="form-control" name="compare_price" value="{{ old('compare_price') }}">
                </div>
                <div class="form-group py-4">
                    <label for="">Storge Quantity</label>
                    <input type="number" class="form-control" name="storgeQuantity" value="{{ old('storgeQuantity') }}">
                </div>
                <div class="form-group py-4">
